...
static int peripheral_hw_version = 3;
...
//&*&*&*JJ1_20110816 touch driver
#if defined(CONFIG_TOUCHSCREEN_FOCALTECH_FT5X0X)
#define ZOOM2_TOUCHSCREEN_IRQ_GPIO	14 /*14(EVT2)*//*99(EVT1)*/
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_TTSP */
//&*&*&*JJ2_20110816 touch driver
...
//&*&*&*HC1_20111011_Mod, modify for EP5a(A7)
static int ep5a_twl4030_keymap[] = {
	/*	row, col, key_val	*/
...
//&*&*&*HC2_20111011_Mod, modify for EP5a(A7)

static struct matrix_keymap_data ep5a_map_data = {
	.keymap			= ep5a_twl4030_keymap,
	.keymap_size		= ARRAY_SIZE(ep5a_twl4030_keymap),
};

static struct twl4030_keypad_data ep5a_kp_twl4030_data = {
	.keymap_data	= &ep5a_map_data,
	.rows		= 3,
	.cols		= 3,
...
//&*&*&*HC2_20110225_Add, modify for EP5a
...
/*20111122, JimmySu optimize backlight curve*/
	omap_pwm = 0xFFFFFAEC + ((brightness) + (brightness * brightness * 0x4 /255) );
...
//	printk("*######***enter [%s] (%d), brightness = %d\n", __FUNCTION__, __LINE__, brightness);
	...
	if ((peripheral_hw_version != BOARD_ID_EVT1) & (zoom_pwm1_output_enabled == 0)){
		zoom_pwm_enable(1);
...
static struct twl4030_platform_data evt_twldata = {
	...
	.usb		= &evt_usb_data,
	.gpio		= &evt_gpio_data,
//&*&*&*HC1_20110225_Add, modify for EP5a
	//.keypad		= &evt_kp_twl4030_data,
	.keypad		= &ep5a_kp_twl4030_data,	
//&*&*&*HC2_20110225_Add, modify for EP5a
...
//&*&*&*JJ1_20110816 FocalTech ft5x0x TouchScreen driver
#if defined(CONFIG_TOUCHSCREEN_FOCALTECH_FT5X0X)
	{
		I2C_BOARD_INFO("ft5x0x_ts",  0x38),
		.irq = OMAP_GPIO_IRQ(ZOOM2_TOUCHSCREEN_IRQ_GPIO),
	},
#endif /* CONFIG_TOUCHSCREEN_FOCALTECH_FT5X0X */
//&*&*&*JJ2_20110816 FocalTech ft5x0x TouchScreen driver
//&*&*&*JJ1
#if (defined(CONFIG_VIDEO_MT9D115) || defined(CONFIG_VIDEO_MT9D115_MODULE))
	{
...
static struct ep10_led_platdata ep10_pdata_button_led1 = {
	.gpio		= 140/*91*/,	//20110816, JimmySu change keypad LED GPIO
	.flags      = LED_CORE_SUSPENDRESUME,	
