...
//	{DAC_CHN_REG, 0xD5},
	...
	/* HPL unmute and gain 0db */
	{LEFT_ANALOG_HPL, 0x95}, //0x80 0dB, 0x88 -4 dB, 0x92 -9dB, 0x95 -10.5dB
	/* HPR unmute and gain 0db */
	{RIGHT_ANALOG_HPR, 0x95}, //0x80 0dB, 0x88 -4 dB, 0x92 -9dB, 0x95 -10.5dB
...
//&*&*&*BC1_110916:fix cts ASR test fail issue
	...
	aic3111_write(codec, LEFT_ANALOG_HPL, 0x95);
	aic3111_write(codec, RIGHT_ANALOG_HPR, 0x95);  
...
//&*&*&*BC1_111110: merge audio stereo channel to mono channel for one speaker		
		if(audio_headset_plugin)
			aic3111_write(codec, DAC_CHN_REG, 0xD6);
		else		
			aic3111_write(codec, DAC_CHN_REG, 0xFE);
//&*&*&*BC2_111110: merge audio stereo channel to mono channel for one speaker					
//&*&*&*BC2_110725: fix the issue that the device has no sounds for some applications when the device resume				
		dac_reg = aic3111_read(codec, DAC_MUTE_CTRL_REG) & ~MUTE_ON;
		aic3111_write(codec, DAC_MUTE_CTRL_REG, dac_reg);	
