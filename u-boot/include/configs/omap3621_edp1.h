...
#define CFG_FASTBOOT_PREBOOT_KEY1         0x01    /* 'Vol -' */
...
#define CFG_INAND_UPDATE_MODE_PREBOOT_KEY1	 0x00	/* 'Vol +' */
...
#else
  #define CONFIG_BOOTARGS "console=ttyO0,115200n8 root=/dev/mmcblk0p2 rw rootwait init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:6M"
...
//&*&*&*20110620_SJ1
	...
	#define CONFIG_INITRAMFS_BOOTARGS_TFT_EMMC_BOOT	"console=ttyO0,115200n8 rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:6M androidboot.console=ttyO0"
...
#define CONFIG_BOOTARGS_TFT_EMMC_BOOT	"console=ttyO0,115200n8 root=/dev/mmcblk0p1 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:6M androidboot.console=ttyO0"
#define CONFIG_BOOTCOMMAND_EMMC  "mmcinit 1; mmc 1 read 82000000 300000 310000; bootm 82000000"
	...
	#define CONFIG_BOOTARGS_TFT_SD1_BOOT "console=ttyO0,115200n8 root=/dev/mmcblk1p2 rw rootwait mem=509M init=/init videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:6M androidboot.console=ttyO0"
#else
	#define CONFIG_BOOTARGS_TFT_SD1_BOOT "console=ttyO0,115200n8 root=/dev/mmcblk0p2 rw rootwait mem=509M init=/init videoout=omap24xxvout videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:6M androidboot.console=ttyO0"
...
#define CONFIG_BOOTARGS_UPDATE_MODE "console=ttyO0,115200n8 videoout=omap24xxvout omap_vout.video1_numbuffers=6 omap_vout.vid1_static_vrfb_alloc=y omapfb.vram=0:6M androidboot.console=ttyO0"
