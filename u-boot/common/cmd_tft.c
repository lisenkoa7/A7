...
static const struct panel_config dvid_cfg = { 
       .timing_h       = ((0xF0 << 20) | (0x0A<<8) | (0x14)), /* Horizantal timing */
       .timing_v       = ((0x10<<20) | (0x0A<<8) | (0x03)), /* Vertical timing */
       .pol_freq       = 0x00003000,//0x00007028, /* Pol Freq */ 
       .divisor        = 0x00010003, /* 58Mhz Pixel Clock */ 
...
static void disp_at070tna2_init(void)
{
	...
	/* GPI0_142 LCD_STB1 */
	sr32((u32)&gpio5_base->oe, 14, 1, 0);
	sr32((u32)&gpio5_base->cleardataout, 14, 1, 1);
	/* GPIO_109 LCD_PWR_EN H:enable L:disable*/
	sr32((u32)&gpio4_base->oe, 13, 1, 0);
	sr32((u32)&gpio4_base->setdataout, 13, 1, 1); /* LCD_EN H:power enable */
	udelay(80000);
	/* GPIO_141 LCD_RST1 */
	sr32((u32)&gpio5_base->oe, 13, 1, 0);
	sr32((u32)&gpio5_base->cleardataout, 13, 1, 1);
	udelay(100000);
	...
	udelay(50000);	
	/* GPIO_101 VGH_CTRL */
	sr32((u32)&gpio4_base->oe, 5, 1, 0);
	sr32((u32)&gpio4_base->setdataout, 5, 1, 1);
	udelay(100000);
	/** /SHTDN High GPIO_37 **/
	...
	/** /SHTDN High GPIO_62 **/
	sr32((u32)&gpio2_base->oe, 30, 1, 0);
	sr32((u32)&gpio2_base->setdataout, 30, 1, 1);
