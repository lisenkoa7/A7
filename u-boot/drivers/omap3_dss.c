...
void omap3_dss_gfx_config(void)
{
       ...
       dss_write_reg(OMAP3621_DISPC_GFX_SIZE, 0x025703ff/*0x02ff03ff*/);   //DISPC_GFX_SIZE -> 767x1023   
//       dss_write_reg(OMAP3621_DISPC_GFX_SIZE, 0x0338012B);   //DISPC_GFX_SIZE -> 825x1200   EPD 9"
       dss_write_reg(OMAP3621_DISPC_GFX_ATTRIBUTES, 0x00000093/*0x0000008d*/);   //DISPC_GFX_ATTRIBUTES -> GFXENABLE:0x1, GFXFORMAT: RGB16, GFXREPLICATION: 0x0 disable, GFXBURSTSIZE: 0x2 16x32bit bursts
