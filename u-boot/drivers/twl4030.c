...
//*&*&*&CJ1_20110902, Change camera 2.8v power source from LDO to PMIC.
	/* turn on VAUX regulator */
	// VAUX2_DEV_GRP
	twl4030_i2c_write_u8(TWL4030_CHIP_PM_RECEIVER, 0x20, 0x76);
	// VAUX2_TYPE
	twl4030_i2c_write_u8(TWL4030_CHIP_PM_RECEIVER, 0x00, 0x77);
	// VAUX2_REMAP
	twl4030_i2c_write_u8(TWL4030_CHIP_PM_RECEIVER, 0x00, 0x78);	
	// VAUX2_DEDICATED
	twl4030_i2c_write_u8(TWL4030_CHIP_PM_RECEIVER, 0x9, 0x79);	
//*&*&*&CJ2_20110902, Change camera 2.8v power source from LDO to PMIC.
...
//&*&*&*HC2_20111025, disable STARTON_USB to prevent booting from unexpected source
